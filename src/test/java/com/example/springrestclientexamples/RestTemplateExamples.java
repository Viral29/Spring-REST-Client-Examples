...
public class RestTemplateExamples {
    ...
    public static final String APT_ROOT="https://api.predic8.de:443/shop";

    @Test
    public void getCategories() throws Exception{

        String api_url = APT_ROOT+"/categories/";
    ...
    public void getCustomers() throws Exception{
        ...
        String api_url = APT_ROOT+"/customers/";
    ...
    public void updateCustomer() throws Exception{
        ...
        postMap.put("firstname","Bob 2");
        postMap.put("lastname","House 2");
    ...
    public void updateCustomerUsingPatchSunHttp() throws Exception {
        ...
        String apiUrl = APT_ROOT + "/customers/";
